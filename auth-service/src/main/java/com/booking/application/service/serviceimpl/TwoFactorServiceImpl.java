...
public class TwoFactorServiceImpl implements
    ...
    // SessionService removed (Phase A.4) - dùng auth.tokens + blacklist
    ...
    public LoginResponse verify2fa(TwoFactorRequest request,
        ...
        // Bước 5: Single Session - kill old refresh tokens of user
        ...
        // Bước 6: Tạo JWT với jti
        // TODO Phase A Bước 11: tạo refresh token + save vào auth.tokens
        //   (hiện tại chỉ tạo access JWT, chưa save DB → giống AuthServiceImpl.login)
        ...
        return LoginResponse.builder()
                ...
                .phoneRequired(isPhoneRequired(user))
                .build();
    }

    /**
     * Phase 7: true nếu user cần bổ sung phone.
     */
